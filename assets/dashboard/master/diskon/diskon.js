function loadForm() {
	$(".load-form").load(base_url + '/admin/diskon/form', function (r, s, x) {
		if (s === 'error') {
...
function remove(page) {
	$(document).on('click', '.hapus', function () {
		...
		var ID = $(this).data('id');
		var url = base_url + "/diskon/remove";
...
function loadFormEdit() {
	...
	$(document).on('click', '.edit', function () {
		...
		var ID = $(this).data('id');
		var url = base_url + "/admin/diskon/form";
		...
		$.ajax({
			...
			complete: function () {
				...
				UrlUp.attr('action', base_url + 'diskon/update');
				formAttribute();
			}
		});
	});
...
function loadData() {
	$(".load-data").load(base_url + '/admin/diskon/data', function (r, s, x) {
		if (s === 'error') {
			console.log('Loaded failed!');
			return false;
		} else {
...
function loadFirstForm() {
	var UrlUp = $(".load-form").closest('.container-fluid').find('form').removeAttr('action');
	UrlUp.attr('action', base_url + 'diskon/store');
}
