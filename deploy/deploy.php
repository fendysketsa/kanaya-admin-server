...
server('prod', '45.13.132.68', 22)
    ->user('admin')
    ->password('anggitrestupi@gmail.com')
    //->identityFile('/home/fendy/.ssh/fendy_kanaya_rsa.pub', '/home/fendy/.ssh/fendy_kanaya_rsa')
    //->forwardAgent()
    ->stage('production')
    ->env('branch', 'fendy')
    ->env('deploy_path', '/home/admin/web/system.kanayamember.id/public_html');

// Your Git repository
set('repository', 'git@gitlab.com:fendysketsa/kanaya-admin.git');
