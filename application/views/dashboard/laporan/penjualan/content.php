            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10">
                            <div class="card px-2 py-2">
                             <form class="form-inline" action="<?php echo site_url('penjualan/print'); ?>" method="POST">
                                ...
                                <div class="form-group mx-sm-3 mb-2">
                                 <div class="input-group to-date">
                                    ...
                                    <input type="text" id="range_date" name="range_date" class="form-control dr-picker"
                                        placeholder="Isikan tanggal awal sampai akhir" required="">
                                </div>
                                 </div>
                                   <div class="form-group mx-sm-3 mb-2">
                                 ...
                                 <div class="form-group mx-sm-3 mb-2">
                                    ...
                                    <select class="form-control" name="type">
                                        <option value="global">Penjualan Global</option>
                                        <option value="rincian">Penjualan Rincian</option>
                                        <option value="kasir">Penjualan Kasir</option>
                                    </select>
                                 </div>
