...
=======
>>>>>>> 2b1ae1c8d89eb874774340e60d91c7b3b9716cbb
		<?php } ?>
		<div class="col-lg-12">
			<div class="card mb-2">
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group input-field">
								...
								<input id="nama" form="formMarketing" value="<?php echo !empty($dataGet) ? $dataGet->username : ''; ?>" name="username" type="text" class="form-control required" placeholder="username ..." required>
							</div>
						</div>
						...
						<div class="col-lg-6">
							<div class="form-group input-field">
								...
								<input id="nama" form="formMarketing" value="" name="password" type="password" class="form-control required" placeholder="kata sandi ..." required>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-lg-6">
			<div class="form-group">
				...
				<input id="tempat_lahir" form="formMarketing" value="<?php echo !empty($dataGet) ? $dataGet->tempat_lahir : ''; ?>" name="tempat_lahir" type="text" class="form-control required" placeholder="tempat Lahir..." required>
			</div>
		</div>
		<div class="col-lg-6">
			<div class="form-group">
		...
		<div class="col-lg-6">
			<div class="form-group">
				...
				<input id="trip_fee" form="formMarketing" value="<?php echo !empty($dataGet) ? $dataGet->trip_fee : ''; ?>" name="trip_fee" type="text" class="form-control required" placeholder="trip fee..." required>
			</div>
		</div>
		...
		<div class="col-lg-6">
			<div class="form-group">
				...
				<input id="point" form="formMarketing" value="<?php echo !empty($dataGet) ? $dataGet->point : ''; ?>" name="point" type="text" class="form-control required" placeholder="point..." required>
			</div>
		</div>
		<div class="col-lg-6">
			<div class="form-group">
