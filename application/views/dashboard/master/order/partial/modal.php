<div class="modal fade" id="formModalOrder" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-content">
            <div class="modal-header title-block">
                ...
                <h5 class="modal-title text-center" id="exampleModalLabel">
                    <em class="fa fa-tags"></em> Perbarui Data Order
                </h5>
            </div>
            ...
            <div class="modal-footer">
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <button href="javascript:void(0)" type="submit" id="submit_marketing" form="formMarketing"
